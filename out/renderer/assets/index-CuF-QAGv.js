...
function LoadingSpinner({ message = "Loading", className = "" }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `flex items-center gap-2 text-xs text-blue-300 ${className}`, children: [
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-6 mb-2 select-none flex items-center gap-3", style: { WebkitAppRegion: "drag" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
          ...
          isLoading && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { WebkitAppRegion: "no-drag" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(LoadingSpinner, { message: "Loading" }) })
        ] }) }),
        ...
        sections.length > 0 && sections[0].stickyBrainSynthesis && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-sm font-semibold text-green-400 flex items-center gap-2", children: "🧠 StickyBrain Synthesis" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-gray-800 border border-green-600/30 rounded p-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-300 leading-relaxed break-words whitespace-pre-line", children: sections[0].stickyBrainSynthesis }) })
        ] }) }),
        false,
        false,
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-4 h-full overflow-hidden", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 space-y-6 min-w-0 overflow-y-auto", children: [
            isLoading && sections.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center text-gray-500 mt-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx(LoadingSpinner, { message: "Processing your stickies", className: "justify-center" }) }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 border-l border-gray-700 pl-4 min-w-0 overflow-y-auto", children: [
            isLoading && sections.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center text-gray-500 mt-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx(LoadingSpinner, { message: "Searching the web", className: "justify-center" }) }),
            sections.length > 0 && (sections[0].webSearchPrompt || sections[0].webSearchResults) ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
